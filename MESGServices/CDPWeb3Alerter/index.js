...
const VAT_ADDR = "0xbA987bDB501d131f766fEe8180Da5d81b34b69d9";
const CDP_MGR_ADDR = "0x1476483dD8C35F25e568113C5f70249D3976ba21";
...
async function getCDP(chatid, vault, threshold, lastMsgSentTime, _id) {
  ...
  if (now - lastMsgSentTime >= 60 * 60) {
    ...
    if (cdp <= threshold) {
      //console.log("ALERT Send Msg!!")
			msg.emitEvent('alert', {
				chatid: chatid,
				message: `🚨🚨🚨 CDP Ratio is in Danger Zone! 🚨🚨🚨\nAct Now before it's too late!\nCDP Ratio for Vault No. ${vault} is ${cdp.toFixed(2)}.`;
			})
    }
  }
}
